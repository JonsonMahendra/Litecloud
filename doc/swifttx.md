...
This mechanism has been integrated into Bitcore-Node-Litecloud which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Litecloud-Project/insight-api-litecloud#web-socket-api](https://github.com/Litecloud-Project/insight-api-litecloud#web-socket-api) 
* API: [https://github.com/Litecloud-Project/insight-api-litecloud#swifttx-transactions](https://github.com/Litecloud-Project/insight-api-litecloud#swifttx-transactions) 
...
By default, the Litecloud Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Litecloud Core daemon:
