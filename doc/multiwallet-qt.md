...
In order to support loading of multiple wallets in litecloud-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is litecloud.cpp.
...
Changes to litecloud.cpp
----------------------
litecloud.cpp is the entry point into litecloud-qt, and as such, will require some minor modifications to provide hooks for
