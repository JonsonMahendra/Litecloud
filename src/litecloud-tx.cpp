...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Litecloud Core litecloud-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  litecloud-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litecloud transaction") + "\n" +
                               "  litecloud-tx [options] -create [commands]   " + _("Create hex-encoded litecloud transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded litecloud transaction
