...
#if defined(NDEBUG)
#error "Litecloud cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
	  ...
	  else if (nHeight <= 85001 && nHeight > 30000) {
        nSubsidy = 12 * COIN;
    }
	  else if (nHeight <= 610601 && nHeight > 85001) {
        nSubsidy = 7 * COIN;
    }
	  else if (nHeight <= 1136201 && nHeight > 610601) {
        nSubsidy = 6 * COIN;
    }
	  else if (nHeight <= 1661801 && nHeight > 1136201) {
        nSubsidy = 5 * COIN;
    }
	  else if (nHeight <= 2713001 && nHeight > 1661801) {
        nSubsidy = 4 * COIN;
    }
	  else if (nHeight <= 3764201 && nHeight > 2713001) {
        nSubsidy = 3 * COIN;
    }
	  else if (nHeight <= 5341001 && nHeight > 3764201) {
        nSubsidy = 2 * COIN;
    }
    else {
        nSubsidy = 0 * COIN;
...
{
    RenameThread("litecloud-scriptch");
