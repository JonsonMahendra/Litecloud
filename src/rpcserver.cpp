...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Litecloud server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Litecloud server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Litecloud features */
        {"litecloud", "masternode", &masternode, true, true, false},
        {"litecloud", "listmasternodes", &listmasternodes, true, true, false},
        {"litecloud", "getmasternodecount", &getmasternodecount, true, true, false},
        {"litecloud", "masternodeconnect", &masternodeconnect, true, true, false},
        {"litecloud", "masternodecurrent", &masternodecurrent, true, true, false},
        {"litecloud", "masternodedebug", &masternodedebug, true, true, false},
        {"litecloud", "startmasternode", &startmasternode, true, true, false},
        {"litecloud", "createmasternodekey", &createmasternodekey, true, true, false},
        {"litecloud", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"litecloud", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"litecloud", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"litecloud", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"litecloud", "getmasternodescores", &getmasternodescores, true, true, false},
        {"litecloud", "mnbudget", &mnbudget, true, true, false},
        {"litecloud", "preparebudget", &preparebudget, true, true, false},
        {"litecloud", "submitbudget", &submitbudget, true, true, false},
        {"litecloud", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"litecloud", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"litecloud", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"litecloud", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"litecloud", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"litecloud", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"litecloud", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"litecloud", "checkbudgets", &checkbudgets, true, true, false},
        {"litecloud", "mnsync", &mnsync, true, true, false},
        {"litecloud", "spork", &spork, true, true, false},
        {"litecloud", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"litecloud", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use litecloudd, or the -server option to litecloud-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> litecloud-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19998/\n";
}
