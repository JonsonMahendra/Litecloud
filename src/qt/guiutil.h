...
/** Utility functions used by the Litecloud Qt UI.
 */
namespace GUIUtil
{
...
// Render Litecloud addresses in monospace font
...
// Parse "litecloud:" URI into recipient object, return true on successful parsing
