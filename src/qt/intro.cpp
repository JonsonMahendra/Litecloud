...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Litecloud Core"),
     ...
     * override -datadir in the litecloud.conf file in the default data directory
     * (to be consistent with litecloudd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
