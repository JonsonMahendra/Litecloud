                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Litecloud Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Litecloud address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and litecloud: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Litecloud Core"), this);
    aboutAction->setStatusTip(tr("Show information about Litecloud Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Litecloud"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Litecloud addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Litecloud addresses"));
    ...
    openAction->setStatusTip(tr("Open a Litecloud: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Litecloud Core help message to get a list with possible Litecloud command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Litecloud Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Litecloud network", "", count));
}
...
{
    QString strTitle = tr("Litecloud Core"); // default title
