...
This means one can have an always-on litecloudd instance running, and another local litecloudd/litecloud-qt instance which connects to this node and receives blocks from it.
