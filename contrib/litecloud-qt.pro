...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/litecloud-cli.cpp \
           src/litecloud-tx.cpp \
           src/litecloud.cpp \
           src/db.cpp \
           ...
           src/qt/litecloud.cpp \
           src/qt/litecloudstrings.cpp \
...
RESOURCES += src/qt/litecloud.qrc src/qt/litecloud_locale.qrc

TRANSLATIONS += src/qt/locale/litecloud_bg.ts \
                src/qt/locale/litecloud_de.ts \
                src/qt/locale/litecloud_en.ts \
                src/qt/locale/litecloud_es.ts \
                src/qt/locale/litecloud_fi.ts \
                src/qt/locale/litecloud_fr.ts \
                src/qt/locale/litecloud_it.ts \
                src/qt/locale/litecloud_ja.ts \
                src/qt/locale/litecloud_pl.ts \
                src/qt/locale/litecloud_pt.ts \
                src/qt/locale/litecloud_ru.ts \
                src/qt/locale/litecloud_sk.ts \
                src/qt/locale/litecloud_sv.ts \
                src/qt/locale/litecloud_vi.ts \
                src/qt/locale/litecloud_zh_CN.ts \
                src/qt/locale/litecloud_zh_TW.ts
